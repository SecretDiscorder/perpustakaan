...
if (!isset($_SESSION["ses_username"])) {
    // Jika session tidak ada, artinya guest
    echo "<p>Selamat datang, Guest. Silakan <a href='login.php'>login</a> untuk mengakses fitur lebih lanjut.</p>";
} else {
...
if (isset($_POST["update_profile"])) {
    ...
    $update_query =
        "UPDATE tb_anggota SET nama = ?, kelas = ?, no_hp = ?, jekel = ? WHERE user_id = ?";
...
$query = "SELECT a.*, p.user_name 
          FROM tb_anggota a
          JOIN tce_users p ON a.user_id = p.user_id
          WHERE p.user_id = ?";
    ...
    <div class="container">
        ...
        <form method="post" action="">
            <div class="form-group">
                <label for="nama">Username (Untuk Login)</label>
                <input type="text" class="form-control" id="nama" name="nama" 
                       value="<?php echo isset($data["nama"])
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_hp" name="no_hp" 
                       value="<?php echo isset($data["no_hp"])
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="jekel" name="jekel" required>
                    <option value="Laki-laki" <?php echo isset(
                        $data["jekel"]
                    ) && $data["jekel"] == "Laki-laki"
                        ? "selected"
                        : ""; ?>>Laki-laki</option>
                    <option value="Perempuan" <?php echo isset(
                        $data["jekel"]
                    ) && $data["jekel"] == "Perempuan"
                        ? "selected"
                        : ""; ?>>Perempuan</option>
                </select>
            </div>
