...
<script>
    function fetchDownloadOptions() {
        ...
        // API Endpoint Django
        const apiUrl = "https://py.bima-pustaka.my.id/api/youtube-download/";
...
<div class="container">
    ...
    <button src="https://py.bima-pustaka.my.id/youtube"><a href="https://py.bima-pustaka.my.id/youtube">Di Pindahkan</a></button>
