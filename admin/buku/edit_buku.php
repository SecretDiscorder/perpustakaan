				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control" required>
                                <?php foreach ($categories as $category) : ?>
                                    <option value="<?= $category ?>" <?php echo ($data_cek['category'] == $category) ? 'selected' : ''; ?>>
                                        <?= $category ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="drive_url" id="drive_url" class="form-control" value="<?php echo $data_cek['drive_url']; ?>">
                        </div>
