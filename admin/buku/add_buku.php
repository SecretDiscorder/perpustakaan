...
function saveManualBook($koneksi) {
    ...
    if ($query_simpan) {
        ...
        echo "<script>
                Swal.fire({title: 'Add Failed', text: 'OK', icon: 'error', confirmButtonText: 'OK'})
                ...
                <div class="box-body">
                    <form method="POST">
                        <div class="form-group">
                            <label>ID Buku</label>
                            <input type="number" class="form-control" name="id_buku" value="<?php echo $format; ?>" readonly>
                        </div>
                        <div class="form-group">
...
<div class="form-group">
                            ...
                            <input type="text" class="form-control" name="drive_url" maxlength="4">
                        </div>
